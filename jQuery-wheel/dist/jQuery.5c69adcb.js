  ...
  return {
    ...
    find: function find(selectStr) {
      ...
      this.each(function (element) {
        List.push.apply(List, _toConsumableArray(element.querySelectorAll(selectStr)));
      });
      return jquery(List);
    },
    ...
    children: function children() {
      var child = [];
      this.each(function (node) {
        child.push.apply(child, _toConsumableArray(node.children));
      });
      return jquery(child);
    },
    end: function end() {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7497" + '/');
